...
def main(argv):
    ...
    True and sys.argv[2].endswith("fasta") == True:
        ...
        print("Two .fasta files not provided. Using defaults from data/fasta/.")
    ...
    for i in range(l1 + l2 -1):
        ...
        statement = "This alignment occurs when the smaller strand (" + str(l2) + "nt in length) attaches from base " \
        + str(i - l2 + 2) + " of the larger strand, with the highest score of " + str(score) + ":" + "\n"
