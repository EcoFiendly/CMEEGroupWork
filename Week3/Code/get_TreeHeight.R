...
#output
strip_csv <- tools::file_path_sans_ext(basename(args[1]))#you want just the 'trees' part of 'trees.csv'
write.csv(Trees, paste("../Results/", strip_csv, "_treeheights.csv", sep="")) #paste input file stripped of the .csv to _treeheights.csv
